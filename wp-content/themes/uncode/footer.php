...
<script type="text/javascript">
	...
	var myAudio4 = new Audio('/wp-content/uploads/2016/07/Ildsjel_Piano_GG.mp3'); 
	function stopaudio(){
	    myAudio.pause();
	...
	var myAudio3 = new Audio('/wp-content/uploads/2016/07/Ildsjel_Piano_EE.mp3'); 
	function stopaudio(){
	    myAudio.pause();
	    myAudio.currentTime = 0;
	}
	...
	var myAudio = new Audio('/wp-content/uploads/2016/07/Ildsjel_Piano_C.mp3'); 
	function stopaudio(){
	    myAudio.pause();
	    myAudio.currentTime = 0;
	}
	...
	var myAudio2 = new Audio('/wp-content/uploads/2016/07/Ildsjel_Piano_A.mp3'); 
	function stopaudio(){
	    myAudio.pause();
	    myAudio.currentTime = 0;
	}
